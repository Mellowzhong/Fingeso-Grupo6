...
<template>
    <form action="" class="flex flex-col space-y-4 pt-4">
        <label for="">
        ...
        <label for="">
            ...
            <input type="password" placeholder="Ingrese su contraseña" required class="w-full border rounded-lg px-2 py-1">
        </label>
        ...
        <label for="">
            ...
            <div class="flex">
                ...
                <input type="tel" name="" id="" pattern="[0-9]{9}" placeholder="Ingrese su número de teléfono" required class="w-full border rounded-r-lg pl-2 py-1">
            </div>
        </label>
        <label for="">
